...
/*
    template <typename T>
    void Union(const set<T>& s, set<T>& d)
    {
        for (auto i = this->begin(); i != this->end(); ++i)
            d.insert(*i);
    ...
    template <typename T>
    void Intersection(const set<T>& s, set<T>& d)
    {
        if (this == &s)
        {
            for (auto it = this->begin(); it != this->end(); ++it)
    ...
    template <typename T>
    void Difference(const set<T>& s, set<T>& d)
    {
        if (this != &s)
        {
...
OutIt setUnion(InIt1 first1, InIt1 last1, InIt2 first2, InIt2 last2, OutIt result)
{
    return set_union(first1, last1, first2, last2, result, std::less<typename std::iterator_traits<InIt1>::value_type>);
}

template<class InIt1, class InIt2, class OutIt, class Compare>
OutIt setUnion(InIt1 first1, InIt1 last1, InIt2 first2, InIt2 last2, OutIt result, Compare comp)
{
...
{
    std::less<typename std::iterator_traits<InIt1>::value_type> c;

    return set_intersection(first1, last1, first2, last2, result, c);
}

template<class InIt1, class InIt2, class OutIt, class Compare>
OutIt set_intersection(InIt1 first1, InIt1 last1, InIt2 first2, InIt2 last2, OutIt result, Compare comp)
{
    while (first1 != last1 && first2 != last2)
    {
        if (comp(*first2, *first1))
...
template<class InIt1, class InIt2, class OutIt, class Compare>
OutIt set_difference(InIt1 first1, InIt1 last1, InIt2 first2, InIt2 last2, OutIt result, Compare comp)
{
    while (first1 != last1 && first2 != last2)
    {
...
template<class InIt1, class InIt2, class OutIt>
OutIt set_symmetric_difference(InIt1 first1, InIt1 last1, InIt2 first2, InIt2 last2, OutIt result)
{
    std::less<typename std::iterator_traits<InIt1>::value_type> c;
...
template<class InIt1, class InIt2, class OutIt, class Compare>
OutIt set_symmetric_difference(InIt1 first1, InIt1 last1, InIt2 first2, InIt2 last2, OutIt result, Compare comp)
{
    while (first1 != last1 && first2 != last2)
    {
        if (comp(*first1, *first2))
